      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-semibold text-gray-800">NeuroScan AI</span>
          </Link>

          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/" className="text-gray-700 hover:text-healthcare-blue transition-colors">
              Home
            </Link>
            ...
            <Link to="/about" className="text-gray-700 hover:text-healthcare-blue transition-colors">
              About
            </Link>
            
            <Link to="/contact" className="text-gray-700 hover:text-healthcare-blue transition-colors">
              Contact
            </Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 animate-fade-in">
          <div className="px-4 py-2 space-y-1">
            ...
            <div className="pt-2">
              <Button className="w-full bg-healthcare-blue hover:bg-opacity-90">
                Get Started
              </Button>
            </div>
          </div>
