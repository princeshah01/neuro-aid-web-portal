    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Our advanced AI system provides fast and accurate tumor classification
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Upload your MRI scan in DICOM, JPG, or PNG format.',
                  icon: (
                ...
                },
                {
                  step: '02',
                  title: 'AI Processing',
                  description: 'Our neural network analyzes the scan using advanced algorithms.',
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-healthcare-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                },
                {
                  step: '03',
                  title: 'View Results',
                  description: 'Receive detailed classification results with visual indicators.',
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-healthcare-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold text-gray-800">Chat with PDF</h2>
              <p className="mt-4 text-lg text-gray-600">
                Upload your medical reports and let our AI assistant analyze them and answer your questions.
              </p>
              ...
              <ul className="mt-6 space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-center">
                    <svg className="h-5 w-5 text-healthcare-green mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="mt-8">
                <Button 
                  ...
                  className="bg-healthcare-blue hover:bg-opacity-90"
                >
                  <Link to="/services/chat-with-pdf" className="flex items-center">
                    Try Chat with PDF
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
              ...
              <div className="bg-white rounded-lg shadow-xl border border-healthcare-gray p-4">
                <div className="bg-healthcare-soft-blue rounded-lg p-5">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-semibold text-gray-800">NeuroScan AI</p>
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    <p className="text-sm text-gray-800">
                      Based on the MRI report uploaded, I found evidence of a 2.3cm lesion in the left temporal lobe consistent with a meningioma. The report indicates WHO Grade I characteristics with no signs of invasion into surrounding tissue.
                    </p>
                  </div>
                  
                  <div className="mt-4">
                    <p className="text-sm text-gray-500 italic">You can ask follow-up questions about this report...</p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-healthcare-blue">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white">Ready to transform your diagnostic process?</h2>
          <p className="mt-4 text-lg text-white/80 max-w-2xl mx-auto">
            Join thousands of healthcare professionals already using our AI-powered platform for faster, 
