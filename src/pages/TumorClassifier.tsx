  ...
  const handleFileUpload = (file: File) => {
    ...
    if (!file.type.startsWith('image/')) {
      toast({
        ...
        description: "Please upload an image file (JPEG, PNG, or DICOM)",
        duration: 5000,
      });
      return;
    }
      ...
      <section className="pt-24 pb-16 md:pt-32 md:pb-24 bg-healthcare-soft-blue">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800">AI Brain Tumor Classifier</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="healthcare-card">
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Upload Brain MRI Scan</h2>
                ...
                <div className="mt-8 animate-fade-in">
                  <div className="bg-healthcare-soft-green rounded-lg p-6 border border-healthcare-green">
                    ...
                    <div className="mt-6 grid md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 h-64 overflow-y-auto">
                          <h4 className="font-semibold text-gray-800">Classification Results:</h4>
                          
                          <div className="mt-4 space-y-3">
                            <div>
                              <p className="text-sm text-gray-600">Primary Classification:</p>
                              <p className="font-medium">Meningioma (WHO Grade I)</p>
                              <div className="mt-1 w-full bg-gray-200 rounded-full h-2">
                                <div className="bg-healthcare-blue h-2 rounded-full" style={{ width: '87%' }}></div>
                              </div>
                            ...
                            <div>
                              <p className="text-sm text-gray-600">Secondary Classification:</p>
                              <p className="font-medium">Benign (Non-malignant)</p>
                              <div className="mt-1 w-full bg-gray-200 rounded-full h-2">
                                <div className="bg-healthcare-green h-2 rounded-full" style={{ width: '92%' }}></div>
                              </div>
                              <div className="flex justify-between text-xs text-gray-500 mt-1">
                            ...
                            <div className="pt-2">
                              <p className="text-sm text-gray-600 font-medium">Key Observations:</p>
                              <ul className="text-sm text-gray-700 list-disc pl-5 space-y-1 mt-2">
                                <li>Well-defined mass in the right frontal lobe</li>
                                <li>No evidence of surrounding edema</li>
                                <li>No midline shift observed</li>
                                <li>No signs of infiltration into adjacent structures</li>
                              </ul>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                      <h4 className="font-semibold text-gray-800">AI Assessment Summary:</h4>
                      <p className="mt-2 text-gray-700">
                        The image analysis suggests a meningioma (WHO Grade I) with high confidence. 
                        The lesion appears well-defined with typical characteristics of a benign meningioma. 
                        There are no concerning features suggestive of malignancy or aggressive behavior.
                      </p>
                      <div className="mt-4">
                        <p className="text-sm text-gray-500 italic">
                          Note: This is an AI-assisted analysis and should be reviewed by a qualified healthcare professional. 
                          This tool is not intended to replace clinical judgment or expertise.
                        </p>
                      </div>
                    </div>
            ...
            {/* Usage Instructions */}
            <div className="mt-12">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">How to Use the Classifier</h3>
              
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  {
                    title: "Upload MRI Scan",
                    description: "Drag and drop your MRI scan image or browse to select a file.",
                    icon: <Upload className="h-6 w-6 text-healthcare-blue" />
                  },
                  {
                    title: "AI Analysis",
                    description: "Our advanced neural network will process and analyze the brain image.",
                    icon: (
                  ...
                  {
                    title: "View Results",
                    description: "Get comprehensive classification results and assessment within seconds.",
                    icon: (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-healthcare-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div key={index} className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                    <div className="flex items-center mb-4">
                      ...
                      <h4 className="ml-3 font-semibold text-gray-800">{step.title}</h4>
                    </div>
            ...
            <div className="mt-12 bg-healthcare-soft-blue rounded-lg p-6">
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <div className="md:w-3/4">
                  <h3 className="text-xl font-semibold text-gray-800">Need help analyzing complex cases?</h3>
                  <p className="mt-2 text-gray-600">
                    Our chat assistant can answer questions about your results and provide additional insights.
                  </p>
                </div>
